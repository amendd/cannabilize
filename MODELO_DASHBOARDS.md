...
Este documento apresenta o modelo de dashboard diferenciado para cada nível de usuário do sistema Cannabilize, com layouts, funcionalidades e experiências específicas para cada perfil.
